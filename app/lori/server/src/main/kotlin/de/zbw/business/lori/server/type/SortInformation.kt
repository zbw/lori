...
enum class SortByField(
    ...
    ENUMERATION(MetadataDB.COLUMN_METADATA_ENUMERATION),
    IS_PART_OF_BOOK(MetadataDB.COLUMN_METADATA_IS_PART_OF_BOOK),
    IS_PART_OF_JOURNAL(MetadataDB.COLUMN_METADATA_IS_PART_OF_JOURNAL),
